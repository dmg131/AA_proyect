...
\midrule
Carlos Vidal Rodríguez & Implementación y tratamiento de la problemática 2, conclusiones Sección~4.4, 4.5.1, 5.3.2, 7\\
David Martínez Gómez & Implementación y tratamiento problemática 1, Trabajo relacionado,  Sección~2, 4.3, 5.3.1 \\
Pau Mateo Lillo & Descripción del problema y los datos: EDA, Preprocesamiento de datos, Modelo baselinem, Sección~3, 4.1, 4.2, 4.5 \\
